...
function Order() {
  ...
  // Load the menu data to associate the ingredients of all the pizzas on the order page here.
  const fetcher = useFetcher();

  // We want to do this when the component mounts, use useEffect to the rescue:
  useEffect(
    function () {
