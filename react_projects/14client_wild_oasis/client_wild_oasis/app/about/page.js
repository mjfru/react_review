  ...
  return (
    <div className="grid items-center grid-cols-5 text-lg gap-x-24 gap-y-32">
      ...
      <div className="col-span-2">
        <Image
          // These images need to be responsive to the grid layout but we need to specify a width...static import to the rescue, granting us access to many other props the Image component is capable of.
